...
public class GUI_Event extends javax.swing.JFrame {
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        ...
        if (selectedRow != -1) {
            String event = model.getValueAt(selectedRow, 0).toString();
            String lokasi = model.getValueAt(selectedRow, 1).toString();
            String tanggal = model.getValueAt(selectedRow, 2).toString();
            double harga = Double.parseDouble(model.getValueAt(selectedRow, 3).toString());
            int jumlah = Integer.parseInt(txtJumlah.getText());

            PemesananTiket tiket = new PemesananTiket(event, lokasi, tanggal, harga, jumlah);
            javax.swing.JOptionPane.showMessageDialog(this, tiket.cetakDetailEvent());
        }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tblData.getModel();
        String event = cmb_event.getSelectedItem().toString();
